...
module.exports = (grunt) ->
    ...
    grunt.registerTask "build", ["clean:dist", "useminPrepare", "copy:dist", "uglify"]
    grunt.registerTask "buildLess", ["clean:dist", "useminPrepare", "concurrent:lessDist", "copy:dist", "uglify", "usemin"]
